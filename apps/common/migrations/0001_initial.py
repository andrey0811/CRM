# Generated migration for common app
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [
                    models.Index(fields=['action', 'created_at'], name='common_act_action_idx'),
                    models.Index(fields=['user', 'created_at'], name='common_act_user_id_idx'),
                ],
            },
        ),
    ]
